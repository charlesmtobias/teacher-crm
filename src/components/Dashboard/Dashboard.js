  ...
  return(
    <div>
      <div className='row my-3'>
        <h2 className='fw-bold'>Hey, Charles! 👋</h2>
      </div>
      <div className='row'>
        <div className='col-md-8'>
          <div className='card mb-3'>
            <div className='card-header'><strong>Progress</strong></div>
          ...
          <div className='row'>
            <h5>Next Lesson</h5>
            <div className='col'>
              <Lesson name="Brad Clip" startTime="11:00" endTime="11:30" next="true" />
            </div>
          </div>
          <div className='row'>
              ...
              <div className='card-body'>
                <div className='row align-items-center'>
                  ...
                  <div className='col-md-auto gx-0'>
                    ...
                    <br />
                    <span className='fst-italic fw-light'>11 Students</span>
                  </div>
                </div>
                <hr />
